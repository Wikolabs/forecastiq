...
const P = {
  ...
  taglines: ["Vos revenus modelises.", "Les pannes detectees avant qu'elles arrivent.", "Pilotez a l'avance."],
  taglineAccentIdx: 1,
  ...
  testimonials: [
    { quote: "On a detecte un effondrement du pipeline commercial 6 semaines avant la fin du trimestre. Ca nous a laisse le temps de reagir et d'eviter un miss a 800K€. ForecastIQ a litteralement sauve notre Q3.", author: "Nicolas P.", role: "CFO, Scale-up SaaS 80 employes" },
    { quote: "Avant, on faisait nos previsions sur Excel et on se trompait de 30%. Maintenant ForecastIQ nous donne un ecart moyen de 8%. Le CODIR pilote enfin sur des chiffres fiables.", author: "Isabelle T.", role: "Directrice Generale, Distribution B2B" },
  ],
  ctaTitle: "Anticipez votre prochain trimestre",
  ctaDesc: "Connexion en 20 minutes. Premieres previsions en 24 heures. Aucune carte bancaire.",
  ctaPrimary: "Reserver un creneau",
  footerTagline: "Previsions de revenus par IA pour dirigeants et CFO",
};
      ...
      <section id="features" style={{ padding:"80px 40px", maxWidth:1100, margin:"0 auto" }}>
        <div style={{ textAlign:"center", marginBottom:52 }}>
          ...
          <h2 style={{ fontSize:"clamp(1.8rem,3.5vw,2.8rem)", fontWeight:700, color:txt1, letterSpacing:"-0.02em", fontFamily:"'Instrument Serif',Georgia,serif", lineHeight:1.15 }}>
            Anticipez, <em style={{ fontStyle:"italic", color:gold }}>n'attendez plus</em>
          </h2>
        </div>
        ...
        <div style={{ maxWidth:860, margin:"0 auto" }}>
          <div style={{ textAlign:"center", marginBottom:48 }}>
            ...
            <h2 style={{ fontSize:"clamp(1.8rem,3.5vw,2.8rem)", fontWeight:700, color:txt1, letterSpacing:"-0.02em", fontFamily:"'Instrument Serif',Georgia,serif" }}>
              Previsions fiables en <em style={{ fontStyle:"italic", color:accent }}>24 heures</em>
            </h2>
          </div>
