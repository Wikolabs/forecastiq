...
export const metadata: Metadata = { title:"ForecastIQ — Previsions de ventes et revenus par IA", description:"ForecastIQ modelise vos previsions de ventes, detecte les anomalies en temps reel et vous alerte avant que le probleme devienne une crise." };
